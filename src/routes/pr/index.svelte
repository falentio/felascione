...
<section class="m-4 flex flex-row flex-wrap justify-between text-center rounded-xl bg-pastel-blue p-2 border-2 border-black">
...
{#await homeworks}
	<section class="m-4 flex flex-row justify-between text-center rounded-xl bg-pastel-blue p-2 border-2 border-black">
		Loading...
	</section>
{:then res}
...
{:catch e}
	<section class="m-4 flex flex-row justify-between text-center rounded-xl bg-pastel-pink p-2 border-2 border-black">
